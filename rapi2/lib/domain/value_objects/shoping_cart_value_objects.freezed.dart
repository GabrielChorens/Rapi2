...
part of 'shoping_cart_value_objects.dart';
...
abstract class $CartItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({int productQuantity, int productID});
}
...
class _$_CartItem implements _CartItem {
  _$_CartItem({required this.productQuantity, required this.productID});
  ...
  @override
  String toString() {
    return 'CartItem(productQuantity: $productQuantity, productID: $productID)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, productQuantity, productID);
...
abstract class _CartItem implements CartItem {
  factory _CartItem(
      ...
      required final int productID}) = _$_CartItem;
