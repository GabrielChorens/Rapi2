...
final _lightTheme = const ColorScheme(
  ...
  surfaceVariant: _Colors.primary20,
...
final _darkTheme = const ColorScheme(
  ...
  onSurfaceVariant: _Colors.primary50P,
...
final _dialogThemeData = DialogTheme(
  ...
  actionsPadding: const EdgeInsets.symmetric(horizontal: 10.0, vertical: 32.0),
);
...
static const display3 = TextStyle(fontSize: 56.0, fontWeight: FontWeight.normal);
static const display2 = TextStyle(fontSize: 45.0, fontWeight: FontWeight.normal);
static const display1 = TextStyle(fontSize: 34.0, fontWeight: FontWeight.normal);
static const headline = TextStyle(fontSize: 24.0, fontWeight: FontWeight.w600);
